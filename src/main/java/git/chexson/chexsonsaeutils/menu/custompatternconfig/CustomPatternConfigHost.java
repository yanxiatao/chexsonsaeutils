...
public class CustomPatternConfigHost {
     ...
     */
    @Nullable
    public CustomPatternProviderLogicHost getProvider(Player player) {
        if (this.provider == null || this.provider.getBlockEntity() == null
            ...
            if (level != null && level.getBlockEntity(this.pos) instanceof CustomPatternProviderLogicHost be) {
                this.provider = be;
            } else {
                this.provider = null;
            }
