...
public final class ChexsonsaeutilsCompatibilityConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue FORMAL_MACHINE_PLANNING_AGGREGATION_ENABLED;
    public static final ForgeConfigSpec.BooleanValue PROCESSING_PATTERN_REPLACEMENT_ENABLED;
    public static final ForgeConfigSpec.BooleanValue DYEABLE_PATTERNS_ENABLED;
    public static final ForgeConfigSpec.ConfigValue<Integer> DYEABLE_RECURSIVE_RETAINED_CATALYST_AMOUNT;
    public static final ForgeConfigSpec.BooleanValue ENHANCED_CRAFTING_STATUS_ENABLED;
    public static final ForgeConfigSpec.BooleanValue BUILDING_GADGETS2_INTEGRATION_ENABLED;
    public static final ForgeConfigSpec.BooleanValue FTB_ULTIMINE_MEMORY_CARD_ENABLED;
    public static final ForgeConfigSpec.BooleanValue PARALLEL_CRAFTING_CPU_ENABLED;
    public static final ForgeConfigSpec.ConfigValue<Integer> PARALLEL_CRAFTING_CPU_CO_PROCESSORS_PER_VIRTUAL_CPU;
    public static final ForgeConfigSpec.ConfigValue<Integer> PARALLEL_CRAFTING_CPU_MAX_INTERNAL_LANES_PER_BLOCK;
    public static final ForgeConfigSpec.ConfigValue<Integer> PARALLEL_CRAFTING_CPU_MAX_INTERNAL_LANES_PER_GRID;
    public static final ForgeConfigSpec.ConfigValue<Integer> PARALLEL_CRAFTING_CPU_MAX_SUBMISSIONS_PER_TICK_PER_GRID;
    public static final ForgeConfigSpec.ConfigValue<Long> PARALLEL_CRAFTING_CPU_MAX_PATTERN_PUSHES_PER_TICK_PER_GRID;
    public static final ForgeConfigSpec.ConfigValue<Long> PARALLEL_CRAFTING_CPU_MAX_PROVIDER_CHECKS_PER_TICK_PER_GRID;
    public static final ForgeConfigSpec.ConfigValue<Long> PARALLEL_CRAFTING_CPU_TICK_BUDGET_NANOS_PER_GRID;
    public static final ForgeConfigSpec.ConfigValue<Long> PARALLEL_CRAFTING_CPU_STORAGE_BYTES;
    public static final ForgeConfigSpec.ConfigValue<Integer> PARALLEL_CRAFTING_CPU_LANE_SHARD_COUNT;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>>
            AE_DIRECT_PROCESSING_MACHINE_RECIPE_MAPPINGS;
    public static final ForgeConfigSpec.ConfigValue<String> AE_DIRECT_PROCESSING_MACHINE_BUDGET_PROFILE;
    public static final ForgeConfigSpec.BooleanValue AE_DIRECT_PROCESSING_MACHINE_GENERIC_DISCOVERY_ENABLED;
